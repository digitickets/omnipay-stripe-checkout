...
use Omnipay\StripeCheckout\Messages\FetchRefundResponse;
...
class FetchRefundRequestTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new FetchRefundRequest(new Client, $this->getHttpRequest());
        $this->request->initialize([
            'apiKey'            => 'api_key_fetch_refund_test',
            'transactionId'     => 'transaction_id_fetch_refund_test'
        ]);
    }
